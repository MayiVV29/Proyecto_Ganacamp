...
public class Perfil_animal_Presenter implements Perfil_Animal_Interface {
    ...
    @Override
    public int data_type_anmls_register(String anmls_r_drog_applied, int anmls_r_cant_drog, String id_propietario, String anmls_r_farm_name, String id_animal, Boolean conexion, Object class_name) {
